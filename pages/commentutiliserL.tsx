      ...
      <div style={styles.wrapper}>
        ...
        <div style={styles.imageContainer}>
          <ImageWithCaption 
            ...
            caption={'To use the language exercise chatbot, write two words and it will derive their lexemes (Wikipedia.org: A lexeme (/ˈlɛksiːm/ ) is a unit of lexical meaning that underlies a set of words that are related through inflection. It is a basic abstract unit of meaning, a unit of morphological analysis in linguistics that roughly corresponds to a set of forms taken by a single root word. For example, in the English language, run, runs, ran and running are forms of the same lexeme, which can be represented as RUN.) and attempt to return an explanation of their etymological common ground. Follow the chatbot\'s instructions to complete the language exercise. Also, for a general approach, you may use the keyword "rnd" to have it automatically substituted with a random, different, word. Etymological connection strength legend:'}
          />
        </div>
